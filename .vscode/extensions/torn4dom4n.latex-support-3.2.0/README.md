...
![LaTeX Preview](https://github.com/ProAdd-ons/vscode-LaTeX-support/raw/master/./images/syntax-highlight.png)
...
pull request to add snippets, make grammar tweaks, etc. Reads [CONTRIBUTING](https://github.com/ProAdd-ons/vscode-LaTeX-support/blob/master/CONTRIBUTING.md) for detail.

## License

Licensed under the [MIT](https://github.com/ProAdd-ons/vscode-LaTeX-support/blob/master/LICENSE.md) License.
